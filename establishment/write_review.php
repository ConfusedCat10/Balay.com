...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        $sql = "INSERT INTO reviews (RoomID, TenantID, StaffScore, FacilitiesScore, CleanlinessScore, ComfortScore, MoneyValueScore, LocationScore, SignalScore, SecurityScore, Comments) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
        ...
        mysqli_stmt_bind_param($stmt, "iiiiiiiiiis", $roomID, $tenantID, $staffScore, $facilitiesScore, $cleanlinessScore, $comfortScore, $moneyValueScore, $locationScore, $signalScore, $securityScore, $comment);
